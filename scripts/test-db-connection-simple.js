...
const configs = [
  {
    name: 'Default (localhost, root, no password, impulsep_moonsun1)',
    config: {
      host: 'localhost',
      user: 'root',
      password: '',
...
async function testAllConnections() {
  ...
  if (successCount === 0) {
    ...
    console.log('   6. Check if the database exists');
  } else {
    console.log('\n✅ At least one connection worked! You can use that configuration.');
  }
}
