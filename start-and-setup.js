...
console.log('🚀 Starting Backend Server and Database Setup...\n');
...
// Wait a bit for server to start, then setup database
setTimeout(async () => {
  ...
  try {
    ...
    console.log('✅ Clients table has data');
    console.log('\n📋 Next steps:');
    console.log('1. Refresh the Master Sales page');
    console.log('2. Click "Test Backend Connection" button');
    console.log('3. You should see real client names from the database');
